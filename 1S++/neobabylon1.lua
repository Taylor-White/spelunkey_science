...
neobabylon1.load_level = function()
	...
	local enemies_dead = {}
	lifebar = 1681 --Number of frames the player has left to live
	level_state.callbacks[#level_state.callbacks+1] = set_callback(function ()
		...
		if frames == 0 then
			...
			local enemy_uid = get_entities_by_type(ENT_TYPE.MONS_OLMITE_HELMET, ENT_TYPE.MONS_OLMITE_BODYARMORED)
